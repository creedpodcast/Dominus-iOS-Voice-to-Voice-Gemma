...
struct EmojiOrb: View {
    ...
    // Base layout. Multiplied by the user's pinch-controlled scale.
    private let baseOuterFrame:   CGFloat = 200
    private let baseDiscDiameter: CGFloat = 110
    ...
    /// Emoji takes up most of the disc — ~72% of the disc diameter so the
    /// glyph reads cleanly even from across the room.
    private var emojiFontSize: CGFloat { discDiameter * 0.72 }
    ...
    private let halftoneRoom: CGFloat = 1.30   // canvas = disc × 1.30
