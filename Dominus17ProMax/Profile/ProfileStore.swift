...
final class ProfileStore {
    ...
    private static let builtInPersona = "Speak with warmth, presence, and a little personality. Stay useful and direct, but do not sound flat or robotic. When the user is exploring something, be more talkative, thoughtful, and collaborative."
    ...
    ///   block so voice-mode replies carry one orb-friendly emoji.
